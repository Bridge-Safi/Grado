...
export const translations = {
  fr: {
    ...
    /* hero */
    badge: "Créateur d'apps · Musique · Vidéos IA",
  ...
  ar: {
    ...
    badge: "تطبيقات · موسيقى · فيديوهات ذكاء اصطناعي",
  ...
  ber: {
    ...
    badge: "Isnasen · Aẓawan · Yividyuten s IA",
    ...
    perk2: "Isnasen, aẓawan & yividyuten",
