    ...
    <>
      ...
      {showModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4"
          ...
          <div className="bg-[#111118] border border-[#2a2a38] rounded-2xl shadow-[0_0_60px_rgba(91,91,214,0.2)] w-full max-w-md p-6">
            {/* Header */}
            ...
            <div className="mb-4">
              ...
              <input
                ...
                className="w-full bg-[#18181f] border border-[#2a2a38] focus:border-[#5B5BD6]/60 rounded-xl px-3 py-2.5 text-sm text-white placeholder-[#555568] outline-none transition-colors"
            ...
            {/* Preview of URL */}
            <div className="bg-[#0D0D12] rounded-xl border border-[#2a2a38] px-3 py-2.5 mb-5">
            ...
            <div className="grid grid-cols-3 gap-2 mb-5">
              {["🌍 En ligne 24/7", "⚡ Hébergement gratuit", "🔗 Lien partageable"].map(p => (
                <div key={p} className="text-center bg-[#18181f] rounded-xl p-2.5 border border-[#2a2a38]">
