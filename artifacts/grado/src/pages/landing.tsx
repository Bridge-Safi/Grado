      ...
      <section className="pt-36 pb-24 px-5 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative">
          ...
          <motion.div
            ...
            className="mt-16 rounded-2xl border border-[#5B5BD6]/20 bg-[#111118] overflow-hidden shadow-[0_0_60px_rgba(91,91,214,0.12)] text-left"
          >
            <div className="border-b border-[#2a2a38] px-4 py-3 flex items-center gap-2 bg-[#0f0f1a]">
            ...
            <div className="p-5 space-y-4">
              ...
              <div className="flex items-start gap-2">
                <div className="w-7 h-7 rounded-full bg-[#18181f] border border-[#5B5BD6]/30 flex items-center justify-center shrink-0 shadow-[0_0_8px_rgba(91,91,214,0.2)]">
                  <GradoLogo size={18} />
                </div>
                <div className="bg-[#18181f] border border-[#2a2a38] text-[#E8E8F0] text-sm rounded-2xl rounded-bl-sm px-4 py-2.5 max-w-sm">
                  ...
                  <div className="mt-2 rounded-lg bg-[#0D0D12] border border-[#5B5BD6]/20 p-3 text-xs text-[#5B5BD6] font-mono">
              ...
              <div className="flex items-start gap-2">
                ...
                <div className="bg-[#18181f] border border-[#2a2a38] text-[#E8E8F0] text-sm rounded-2xl rounded-bl-sm px-4 py-2.5 max-w-sm">
                  ...
                  <div className="mt-2 flex items-center gap-2 bg-[#0D0D12] rounded-lg p-2.5 border border-[#5B5BD6]/20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {FEATURES.map((f, i) => (
              <motion.div
                ...
                className="bg-[#111118] border border-[#2a2a38] rounded-2xl p-6 hover:border-[#5B5BD6]/50 hover:shadow-[0_0_24px_rgba(91,91,214,0.1)] transition-all group"
              >
