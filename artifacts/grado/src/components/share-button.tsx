...
interface ShareButtonProps {
  ...
  label?: string;
  rtl?: boolean;
  /** Icon-only trigger for tight toolbars (e.g. the live preview address bar) */
  compact?: boolean;
  /** Anchor the popover from the bottom instead of the top (useful in a top toolbar) */
  align?: "top" | "bottom";
}
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className={cn(
              "absolute z-50 bg-[#1a1a24] border border-[#2a2a38] rounded-xl p-3 w-72 shadow-xl",
