  ...
  return (
    <div className="min-h-screen bg-[#0D0D12] text-white">
      ...
      <main className="max-w-4xl mx-auto px-5 py-10">
            ...
            <AnimatePresence>
              {mySites.map((site, i) => (
                <motion.div key={site.slug}
                  ...
                  className="group rounded-2xl border border-[#2a2a38] bg-[#111118] hover:border-[#5B5BD6]/30 transition-all p-5 flex items-center gap-4">
        ...
        {/* Custom domain info */}
        <div className="mt-10 rounded-2xl border border-[#2a2a38] bg-[#111118] p-6">
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <div className="bg-[#0D0D12] rounded-xl p-3 font-mono text-xs border border-[#2a2a38] space-y-1">
